...
public class FrontUtils {
	...
	/**
	 * <b>概要：</b>
	 * 	获得模板路径。将对模板文件名称进行本地化处理。  如：/WEB-INF/t/cms/www/red/common/页面没有找到.html
	 * <b>作者：</b>SUXH </br>
	 ...
	 * <b>日期：</b>Apr 10, 2016 </br>
	 * @param pageNo 第几页
	 * @param href 路径 如index.jhtml
	 * @param hrefFormer 路径前缀 index
	 * @param hrefLatter 路径后缀 jhtml
	 * @param map 模型数据
	 */
